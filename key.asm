...
mov bx,ScanCodeTable
  ...
  ; shft any line to next line
       ...
       add ebp,edx
        ...
        mov esi,0xB8f00
        KKK:
        sub esi,2 ; last letter in line 24 
        mov cl,[esi] 
        mov byte[esi],0
      shf:
       mov dl,cl
  ...
  backspace:
     ...
     L:
      ...
      jne L
      sub edi,2
       cmp byte[page],0 ; to stay within screen
       jne BP2
       BP1:
       cmp edi,0xb8000
       jae M
...
capslock:
 ...
 Shading:;compare with four bytes
  ...
  NNL:   
       ...
       cmp al,0xE0
       jne M
  UAL: ;UP Araaw with Leftshift or rightshift
       in al,0x64
       and al,0x1
       jz UAL
       in al,0x60
       ...
       jmp M
       RT:
       mov byte[edi-1],55;shading
       sub edi,2
       loop TT
       jmp M
 DAL: ;Dwn Araaw with Leftshift or rightshift
    cmp al,0x50  ;dwn araaw 
       ...
       loop WW
       jmp M
 RAL: ;Right Araaw with Leftshift or rightshift
   cmp al,0x4d ;right arraw
      jne LAL
      cmp byte[edi],0
      je M
      cmp byte[edi+1],0x07;screen color 
      je SR
      mov byte[edi+1],0x07 ;remove shading
      add edi,2
      jmp M
      SR:   
      mov byte[edi+1],55 ;shading
      add edi,2 
      jmp M
 LAL: ;Left Araaw with Leftshift or rightshift
...
ScanCodeTableNumlock:db  "//1234567890-=//qwertyuiop[]//asdfghjkl;'`/\zxcvbnm,.//// /////////////789-456+1230."
